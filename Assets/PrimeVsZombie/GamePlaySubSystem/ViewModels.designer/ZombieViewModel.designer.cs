...
namespace PrimeVsZombieDB {
    ...
    public partial class ZombieViewModelBase : uFrame.MVVM.ViewModels.ViewModel {
        
        public ZombieViewModelBase(uFrame.Kernel.IEventAggregator aggregator) : 
                base(aggregator) {
        }
    ...
    public partial class ZombieViewModel {
        
        public ZombieViewModel(uFrame.Kernel.IEventAggregator aggregator) : 
                base(aggregator) {
        }
    }
}
