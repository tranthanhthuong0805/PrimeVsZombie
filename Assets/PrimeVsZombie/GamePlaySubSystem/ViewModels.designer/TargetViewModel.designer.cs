...
namespace PrimeVsZombieDB {
    ...
    public partial class TargetViewModelBase : uFrame.MVVM.ViewModels.ViewModel {
        
        public TargetViewModelBase(uFrame.Kernel.IEventAggregator aggregator) : 
                base(aggregator) {
        }
    ...
    public partial class TargetViewModel {
        ...
        public TargetViewModel(uFrame.Kernel.IEventAggregator aggregator) : 
                base(aggregator) {
        }
    }
}
